                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post"  id="imageForm" action="<?php echo base_url('Admin/job/update'); ?>"
                             enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                        <input type="hidden" class=""
                                                        id="" name="job_id"  value="<?=$job->id?>">
                                            <div class="col-sm-6">
                                                <div class="form-group"> 
                                                    <label class="control-label font-weight-600">Job
                                                        Experience</label>
                                                    <select class="form-control fn-15 ht-45" name="job_experience" style="appearance: auto;" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="job_designation" value="<?=$job->job_designation?>">
                                    ...
                                    <div class="col-sm-12 mt-1">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label font-weight-600">Job Location</label>
                                                   
                                                        <input type="text" class="form-control" id="" name="job_location"  value="<?=$job->job_location?>">
                                                    <?php echo form_error('job_location', '<div class="error">', '</div>'); ?>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 mt-1">
                                                <div class="form-group">
                                                    <label class="control-label font-weight-600">Job Duration</label>
                                                    <input type="text" class="form-control "
                                                        id="" name="job_duration"  value="<?=$job->job_duration?>">
