                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td style="width: 60px;">
                                                                <div class="avatar-xs">
                                                                    <div class="avatar-title rounded-circle bg-light">
                                                                        <img src="<?= base_url('assets') ?>/images/companies/img-1.png" alt="img-1" height="20">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="avatar-xs">
                                                                    <div class="avatar-title rounded-circle bg-light">
                                                                        <img src="<?= base_url('assets') ?>/images/companies/img-2.png" alt="img-2" height="20">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="avatar-xs">
                                                                    <div class="avatar-title rounded-circle bg-light">
                                                                        <img src="<?= base_url('assets') ?>/images/companies/img-3.png" alt="img-3" height="20">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                    ...
                                                    <li>
                                                        <div class="conversation-list">
                                                            <div class="chat-avatar">
                                                                <img src="<?= base_url('assets') ?>/images/users/avatar-2.jpg" alt="avatar-2">
                                                            </div>
